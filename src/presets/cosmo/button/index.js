export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // Primary Button
            {
                'text-white dark:text-surface-white': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
            ...
            // Danger Button
            {
                'text-white dark:text-surface-50': props.severity === 'danger' && !props.text && !props.outlined && !props.plain,
            ...
            // Primary
            { 'hover:bg-primary-600 dark:hover:bg-primary-700 hover:border-primary-700 dark:hover:border-primary-700': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain },
